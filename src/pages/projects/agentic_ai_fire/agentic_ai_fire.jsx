  ...
  return (
    <ProjectDetail8
      ...
      media={[
        {
          kind: "video",
          src: `${import.meta.env.BASE_URL}/landing/agentic_ai_fire/demo_video_short_agentic_ai.mp4`,
          alt: "",
          caption: "LLM-powered chatbot interface: providing a street address triggers retrieval simulation parameters via 3D voxel-based fire simulation and running a fire-spread model.",
          wpercentage: 100
        },
        {
          kind: "video",
          src: `${import.meta.env.BASE_URL}/landing/agentic_ai_fire/chat_fire_spark.mp4`,
          alt: "",
          caption: "LLM-powered chatbot interface for automating 2D CSIRO Spark fire-spread simulations.",
          wpercentage: 100
        },
        {
          kind: "image",
          src: `${import.meta.env.BASE_URL}/landing/agentic_ai_fire/agentic_ai_fire_concept.png`,
          alt: "",
          title: "Demo",
          caption: "Agentic AI framework for interactive wildfire scenario generation, multi-model simulation, and immersive mixed-reality visualization.",
          wpercentage: 100
        }        
      ]}
      title="Community-Oriented Wildfire Planning with Agentic AI"
      subtitle="Automating wildfire scenario configuration, fire-spread simulation, and interactive 3D visualization through natural-language interaction"
      sponsor_logos={[
      ...
      introLeft={
        <>
          <p>
            This research presents an intelligent and interactive framework
            that helps communities, planners, emergency responders, and fire
            specialists explore wildfire scenarios and mitigation strategies.
            Users describe a scenario through a conversational interface, and
            the agentic AI system translates the request into a structured
            scientific workflow for wildfire simulation and visualization.
          </p>

          <p className="mt-3">
            The framework connects natural-language interaction with
            geospatial data processing, the CSIRO SPARK 2D wildfire model, a
            voxel-based 3D fire simulator, browser-based visualization, and
            immersive holographic displays. Its purpose is to reduce the
            technical barriers associated with preparing simulation inputs,
            configuring models, and interpreting complex fire-spread results.
          </p>
        </>
      }
      ...
      introRight={   
         <ul className="list-disc list-inside text-slate-700">
          <li>
            Enables users to define wildfire scenarios through conversational
            natural-language queries and map-based spatial interaction.
          </li>

          <li>
            Uses a layered agentic AI architecture comprising interaction,
            cognitive, execution, and visualization components.
          </li>

          <li>
            Automatically extracts locations, environmental conditions, dates,
            and simulation requirements from user requests.
          </li>

          <li>
            Integrates the CSIRO SPARK framework for automated 2D wildfire
            simulation through an API-based workflow.
          </li>

          <li>
            Supports developing integration with a voxel-based simulator for
            volumetric fire behaviour in complex urban environments.
          </li>

          <li>
            Delivers simulation outputs through an interactive browser-based
            3D viewer and immersive holographic table and wall displays.
          </li>

          <li>
            Demonstrated more than 12 three-dimensional scenarios involving
            surface fires, apartment fires, high-rise fires, and different
            wind conditions.
          </li>

          <li>
            Evaluated qualitatively with firefighters and domain researchers
            using the UNSW immersive visualization facilities.
          </li>
        </ul>
      }
      relatedLinks={[
      ...
      publications={[
        {
          ...
          venue: "ISPRS Annals of the Photogrammetry, Remote Sensing and Spatial Information Sciences, Volume XI-4-2026",
          year: "2026",
          url: "https://isprs-annals.copernicus.org/articles/XI-4-2026/251/2026/isprs-annals-XI-4-2026-251-2026.pdf",
