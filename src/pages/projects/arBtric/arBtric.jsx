...
export function ArBtric() {
  return (
    <ProjectDetail12
      ...
      media={[
        {
          ...
          src: `${import.meta.env.BASE_URL}/landing/ArBtric/arBuilding.mp4`,

          alt:
            "Mobile augmented reality application for interactive smart building operation and equipment control",

          caption:
            "Mobile augmented reality interface connecting users with building equipment and operational information through an interactive smartphone-based environment.",
...

        {
          ...
          // KEEP VIDEO UNCHANGED
          src: `${import.meta.env.BASE_URL}/landing/ArBtric/DtBuilding.mp4`,

          alt:
            "3D digital twin of a smart building and its mechanical systems",

          autoPlay: true,

          caption:
            "Building digital twin integrating 3D building geometry, equipment, operational information, and smart-building systems for interactive visualization and control.",
      ...
      title="Augmented Reality & Digital Twin for Smart Building Operations"

      subtitle="A mobile AR-enabled digital twin platform connecting physical building equipment with interactive 3D visualization, operational information, and smartphone-based control"
      ...
      sponsor_logos={[
        {
          src: `${import.meta.env.BASE_URL}/landing/ArBtric/doe_logo.png`,
          alt: "BHP",
        },
      ...
      introLeft={
        <>
          <p>
            ...
            <strong> augmented reality-enabled digital twin platform </strong>
            for interactive smart building operation and equipment
            management. The system integrates a 3D digital representation
            of the building with a mobile augmented reality application,
            allowing users to interact with building systems directly
            through a smartphone.
          </p>

          <p className="mt-3">
            The digital twin provides a virtual representation of the
            building environment and its operational assets, connecting
            physical equipment with corresponding digital objects,
            equipment information, operational states, and control
            functions. Complex building systems, including
            <strong> dual-source heat pumps</strong>, can therefore be
            represented and accessed within a unified digital environment.
          </p>

          <p className="mt-3">
            The mobile AR application extends the digital twin into the
            physical building environment. By viewing equipment through a
            smartphone, users can access contextual digital information and
            interact with corresponding building systems through an
            intuitive spatial interface. This creates a direct connection
            between
            <strong> physical assets, digital twins, operational data,
            and human interaction</strong>.
          </p>

          <p className="mt-3">
            The project demonstrates how digital twins and augmented
            reality can move beyond passive 3D visualization toward
            <strong> interactive cyber-physical building operations</strong>.
            The approach provides a foundation for smart building
            monitoring, equipment control, facility management,
            maintenance, operator training, and human-centered interaction
            with increasingly complex building systems.
          </p>
        </>
      }
      ...
      introRight={
        <ul className="list-inside list-disc space-y-2 text-slate-700">
          ...
          <li>
            Developed a
            <strong> 3D digital twin of the building environment</strong>{" "}
            integrating building geometry, equipment, and operational
            information.
          </li>

          <li>
            Developed a
            <strong> smartphone-based augmented reality application</strong>{" "}
            for interacting with physical building assets.
          </li>

          <li>
            Connected
            <strong> physical equipment with corresponding digital objects</strong>{" "}
            within the building digital twin.
          </li>

          <li>
            Enabled users to access equipment information and operational
            functions through a
            <strong> spatially contextualized AR interface</strong>.
          </li>

          <li>
            Demonstrated digital representation and interaction with
            <strong> complex HVAC equipment, including dual-source heat pumps</strong>.
          </li>

          <li>
            Enabled mobile interaction with building systems for
            <strong> monitoring and operational control</strong>.
          </li>

          <li>
            Integrated
            <strong> 3D visualization, building information,
            operational data, and control interfaces</strong> {" "}
            within a unified digital environment.
          </li>

          <li>
            Created an intuitive
            <strong> human–building interaction interface</strong>{" "}
            that connects operators directly with physical assets through
            augmented reality.
          </li>

          <li>
            Demonstrated a transition from conventional building
            visualization toward
            <strong> interactive cyber-physical digital twins</strong>.
          </li>

          <li>
            Provides a foundation for applications in
            <strong> smart building operations, facility management,
            equipment maintenance, diagnostics, and operator training</strong>.
          </li>
      ...
      publications={[
        {
          authors: "Shi, L., Qu, M., Liu, X., Venegas, T. P., Wang, L., Dong, J., et al.",
          title: "Performance Evaluation of Underground Thermal Storage Integrated Dual-Source Heat Pump Systems",
          venue: "Energy and Buildings, 316, 114349",
          year: "2024",
          doi: "https://doi.org/10.1016/j.enbuild.2024.114349",
