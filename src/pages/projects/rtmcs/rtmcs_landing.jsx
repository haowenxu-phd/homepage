...
export function RtmcsDetail() {
  return (
    <ProjectDetail3
      ...
      sponsor_logos={[
        { src: `${import.meta.env.BASE_URL}/landing/rtmcs/combined_logo.png`, alt: "ARPA-E & USDOE" },
      ...
      introLeft={
        <>
          <p>
           This project introduces a mobile edge computing framework that transforms ordinary smartphones into intelligent edge devices for traffic optimization. By integrating IoT-connected traffic signals, real-time vehicle-to-infrastructure (V2I) communication, and speed optimization algorithms, the system delivers second-by-second speed advisories to drivers through a mobile app. Unlike traditional approaches that rely on costly onboard hardware, this scalable solution leverages existing mobile devices to reduce stop-and-go driving, cut fuel consumption, and lower emissions. Extensive simulations, lab experiments, and field tests demonstrate its robustness and energy-saving potential—showing up to 24% reduction in energy use when widely adopted. The framework highlights the power of cyber-physical integration in creating practical, deployable solutions for sustainable urban mobility.
            </p>
          <p className="mt-3">
      ...
      introRight={   
         <ul className="list-disc list-inside text-slate-700">
          <li>Designed a mobile edge computing framework that turns smartphones into real-time edge devices for traffic optimization at urban intersections.</li>
          <li>Integrated IoT-connected traffic signal controllers, roadside sensors, and cloud-based cyberinfrastructure for vehicle-to-infrastructure (V2I) communication.</li>
          <li>Deployed the Distributed Queue-aware Eco-Approach Strategy (DQ-EAS) algorithm on mobile devices to generate second-by-second speed advisories.</li>
          <li>Conducted CAVE lab experiments, traffic simulations, and field tests to validate scalability, usability, and energy-saving performance.</li>
          <li>Achieved up to 24% reduction in system-wide energy consumption in simulation scenarios, highlighting strong sustainability potential.</li>
          <li>Implemented a cross-platform mobile app (iOS/Android) with visual and audio-based driver interactions for safe and intuitive use.</li>
        </ul>
      }
      relatedLinks={[
        ...
        { label: "Real-world traffic demo reveals energy savings", href: "https://www.ornl.gov/news/real-world-traffic-demo-reveals-energy-savings/", tag: "press" },
        { label: "ORNL CAVE Lab", href: "https://www.ornl.gov/content/connected-and-automated-vehicle-environment-laboratory-cave", tag: "press" },
      ...
      publications={[
        {
          ...
          year: "2023",
          url: "https://ieeexplore.ieee.org/document/10321698",
