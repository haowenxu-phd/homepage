...
import text from "./assets/course_5_trafficcontrol/trans/course.json";
...
import TrafficMap
  from "./assets/course_4_greenshields/components/TrafficMap_5";
...
import {
  createTrafficSignalAtLaneEnd
} from "./assets/course_4_greenshields/simulation/trafficControl/signalPlacement";


import {
  getTrafficSignalState
} from "./assets/course_4_greenshields/simulation/trafficControl/signalTiming";


import {
  findSignalConstraint
} from "./assets/course_4_greenshields/simulation/trafficControl/signalPerception";

import TrafficSignalLayer
  from "./assets/course_4_greenshields/components/TrafficSignalLayer";
...
export default function InteractiveLearning_c5_Traffic_Control() {
    ...
    // =======================================================
    // Traffic signal timing controls
    // =======================================================
    ...
    //
    // IMPORTANT:
    // timing states are already initialized above
    // =======================================================
    ...
    const trafficSignals =
      ...
      // =======================================================
      // Current displayed signal state
      // =======================================================
            ...
            const movedVehicles =
                currentVehicles.map(
                  ...
                  findLeader(
                    ...
                    // =====================================
                    // 2. Traffic-control obstacle
                    // =====================================

                    const signalLeaderInfo =
                          findSignalConstraint({
                    ...
                    if (
                      ...
                      (
                        !vehicleLeaderInfo ||
                        signalLeaderInfo.gapM <
                          vehicleLeaderInfo.gapM
                      )
                    ) {
      ...
      {/* =====================================================
        ...
        >
          ...
          <div
            ...
            "
          >
            {t.signalTiming ?? "Traffic Signal Timing"}
          </div>
      ...
      <div
        ...
        >
          ...
          <span
            ...
            "
          >
            {t.currentSignal ?? "Current Signal"}
          </span>
