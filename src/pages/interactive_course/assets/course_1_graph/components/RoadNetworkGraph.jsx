...
const d3NodesRef = useRef([]);
  ...
  graphLayer;
      ...
      // Zoom + pan
      //
      // SVG receives the mouse interaction.
      // graphLayer is transformed.
      //
      // Mouse wheel = zoom
      ...
      // Save zoom behavior so another React effect
      // can programmatically control the view.
      zoomBehaviorRef.current =
        zoomBehavior;


      // Disable D3's default double-click zoom.
      // Remove this if you WANT double-click to zoom.
      svg.on(
        "dblclick.zoom",
        null
      );
    ...
    node.call(
      ...
      return () => {
        ...
        // ============================================================
          // Leaflet -> D3 camera focus
          //
          // When selectedLaneId changes:
          //
          // 1. Find corresponding D3 node
          // 2. Read its current force-layout x/y
          // 3. Zoom and pan to it
          // ============================================================
          ...
          useEffect(() => {
                ...
                if (
                  ...
                  console.warn(
                    "D3 node has no valid position yet:",
                    selectedLaneId,
                    selectedNode
                  );
