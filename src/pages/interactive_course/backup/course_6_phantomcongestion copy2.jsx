...
export default function InteractiveLearning_c6_Phantom() {
  ...
  // =======================================================
  // IMPORTANT:
  // Car-following model state MUST be here.
  // This is the top level of the React component.
  // =======================================================
              ...
              const updatedVehicles =
                currentVehicles.map(
                  vehicle => {
                    ...
                    // =====================================
                    // Selected car-following model
                    //
                    // The 4th argument is now the dropdown
                    // selection.
                    // =====================================
            ...
            >

              {
                ...
                "idm"
                  ? (
                      <>
                        Human-driver baseline using
                        desired speed, spacing and
                        relative speed.
                      </>
                    )
                  ...
                  ? (
                      <>
                        Driver adjusts speed according
                        to the available spacing.
                      </>
                    )
                  ...
                  ? (
                      <>
                        Automated following using
                        spacing and relative-speed
                        feedback.
                      </>
                    )
                  ...
                  : (
                      <>
                        ...
                        uses connected-vehicle
                        information to damp traffic
                        waves.
                      </>
                    )
              }
